...
char *deprecated_remove_dup_lines(char *const in_text, unsigned int * );
char *remove_dup_groups(char *const in_text, unsigned short line_depth, unsigned short, unsigned int *);
